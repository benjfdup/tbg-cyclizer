...
import os
os.makedirs("/home/bfd21/rds/hpc-work/tbg/jobs/job-Nov-27/logs", exist_ok=True)
...
PATH_last = "/home/bfd21/rds/hpc-work/tbg/bfd_models/Flow-Matching-L1-test-bb_all_sc_adjacent.pth"
...
logger.add("/home/bfd21/rds/hpc-work/tbg/jobs/job-Nov-27/training_log.log", rotation="500 MB", retention="10 days", level="INFO")

# Initialize wandb
wandb.init(
    project="L1-Nov-21-2024-bb_all_sc_adj",  # Name of your wandb project
    config={
        "n_particles": n_particles,
        "dim": dim,
        "hidden_nf": 64,
    ...
    dir="/home/bfd21/rds/hpc-work/tbg/jobs/job-Nov-27/logs"
)
