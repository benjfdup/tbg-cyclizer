...
import os
os.makedirs("/home/bfd21/rds/hpc-work/tbg/jobs/job-Nov-21/logs", exist_ok=True)

### THIS IS RECORDED IN MY NOTEBOOK AS "FULL LIGAND"
### THIS HAS MY ECODING, AND A STANDARD (ALL CONNECTED) ARCHITECTURE
...
logger.add("/home/bfd21/rds/hpc-work/tbg/jobs/job-Nov-21/training_log.log", rotation="500 MB", retention="10 days", level="INFO")
...
wandb.init(
    ...
    dir="/home/bfd21/rds/hpc-work/tbg/jobs/job-Nov-21/logs"
)
